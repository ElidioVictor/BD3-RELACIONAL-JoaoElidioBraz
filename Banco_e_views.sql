...
describe tb_paciente_back;
select * from tb_paciente;
select * from tb_agenda;
select * from tb_paciente_back;
delete from tb_paciente where id_paciente = 5;
drop trigger trg_delete_paciente;
